...
function renderNav() {
  ...
  host.innerHTML = `
    <header class="site-header"> 
      ...
      <a class="site-header__sponsor" href="https://imprint.gg/" target="_blank" rel="noopener" aria-label="Imprint Esports">
        <img src="assets/sponsoredimages/img3.png" alt="Imprint Esports" class="site-header__sponsor-mark">
      </a>
