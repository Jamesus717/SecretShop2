  ...
  host.innerHTML = `
    <header class="site-header"> 
      <div class="site-header__brand"> 
        <a href="index.html" class="site-header__home-link" aria-label="Home"> 
          <img src="assets/logo.png" alt="SecretShop Logo" class="site-header__logo"> 
          <span class="site-header__name">SecretShop</span> 
        </a> 
      </div> 
